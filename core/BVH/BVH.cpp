...
BVH::BVH()
    : nNodes(0), nLeafs(0), leafSize(0), build_prims(NULL), flatTree(NULL)
{
...
void BVH::build(std::vector<Object*>* objects, uint32_t leafSize)    
{
    this->leafSize = leafSize;
    this->build_prims = objects;
    _build();
}
